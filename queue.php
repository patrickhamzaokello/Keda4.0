        ...
        <div class="player-wrapper player-queuelist">
            ...
            <div class="player-container">
                <div class="queuelist-cover">
                    <div class="queuelist-cover-thumbnail">
                        <figure class="figurethumbnail">
                            <div class="picture overlay-hidden no-background">
                                <img id="queueimage" src="<?= $songAlbum->getArtworkPath() ?>" loading="lazy" alt="Skin" class="sk__sc-10y8cfp-0 aBWjY picture-img" height="380" width="380">
                        </figure>
                    </div>
                    ...
                    <div class="queuelist-cover-title"><a id="queuesongtitle" class="queuelist-cover-link" href="#"><?= $albumSong->getTitle() ?></a></div>
                    <div class="queuelist-cover-subtitle"><a id="queuesongArtist" class="queuelist-cover-link" href="#"><?= $albumArtist->getName() ?></a></div>
                </div>
                <div class="queuelist-content">
                    <div class="queuelist-header">
                        <div class="queuelist-heading"><span class="queuelist-title">Queue</span><span class="queuelist-subtitle"> · tracks </span></div>
